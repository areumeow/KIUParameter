...
export const artworks: Artwork[] = [
  // SongSeungHaw (3 works)
  {
    ...
    previewVideoUrl: '/KIUParameter/001.mov' ,
    duration: '00:30',
  ...
  },
  {
    ...
    previewVideoUrl: '/KIUParameter/002.mov' ,
    duration: '00:30',
    format: 'MP4 / 1280*1280',
    bankName: 'KB Kookmin Bank',
    accountNumber: '1111-22-3333333',
  },
  {
    ...
    previewVideoUrl: '/KIUParameter/003.mov' ,
    duration: '00:30',
    format: 'MP4 / 1280*1280',
    bankName: 'KB Kookmin Bank',
    accountNumber: '1111-22-3333333',
  ...
  // JangMyu (3 works)
  {
    ...
    previewVideoUrl: '/KIUParameter/bomb.mov' ,
    duration: '00:20',
    format: 'MOV / 1280p',
    bankName: 'KB Kookmin Bank',
    accountNumber: '1111-22-3333333',
  },
  {
    ...
    previewVideoUrl: '/KIUParameter/eum.mov' ,
    duration: '00:30',
    format: 'MOV / 1280p',
    bankName: 'KB Kookmin Bank',
    accountNumber: '1111-22-3333333',
  },
  {
    ...
    previewVideoUrl: '/KIUParameter/TDMovie.mov' ,
    duration: '00:25',
    format: 'MOV / 1280p',
    bankName: 'KB Kookmin Bank',
    accountNumber: '1111-22-3333333',
